...
enum Sons_t { AH = 1, AVION = 2, BOIRE = 3, BOIS_1 = 4, BOIS_2 = 5, BRUIT = 6, VENT = 7, ELEC_FAIBLE = 8, ELEC_FORT = 9, CRACK_1 = 10, CRACK_2 = 11, DEBARRER = 12, DOUCHE = 13, FERMETURE_PORTE = 14, FOND = 15, GRILLE = 16, HORLOGE = 17, INVENTAIRE = 18, MUNCH_1 = 19, MUNCH_2 = 20, MUNCH_3 = 21, OUVERTURE_PORTE_1 = 22, OUVERTURE_PORTE_2 = 23, PAPIER_1 = 24, PAPIER_2 = 25, PAPIER_3 = 26, PORTE_BARRE = 27, RECHARGE = 28, RESPIRATION = 29, RONFLEMENT_1 = 30, RONFLEMENT_2 = 31, RONFLEMENT_3 = 32, RONFLEMENT_4 = 33, RONFLEMENT_5 = 34, SNIF = 35, TIR = 36, TIRROIR_1 = 37, TIRROIR_2 = 38, TONNERE = 39, TOUX_1 = 40, TOUX_2 = 41, COUPLUGER = 42, COUPTHOMPSON = 43, EQUIPERFUSIL = 44, MIRE = 45, EQUIPERCOUTEAU = 46, COUPCOUTEAU = 47, COUPCOUTEAUVIDE = 48, EQUIPERCANONAPEINTURE = 49, CANONAPEINTURE = 50, COEUR = 51, PAS = 52 };
