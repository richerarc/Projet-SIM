...
###`de 10h à 1h`
Aujourd'hui tout le groupe était présent malgré l'Absence du professeur, nous avons eu une discussion de groupe sur ou toutes les équipes étaient rendues. 

Ensuite, j'ai mis les choses au clair avec le reste de la classe pour ce qui est des textures pour les modeles 3D. J'ai aussi fait sur avec Jessy sur l'adaptation de son code pour afficher bien les images en 2D(Pour ce qui est du 2D les images ne doivent pas subir de transformation je crois).

Moi et Jessy avons travaillés ensemble pour faire un main et la classe jeu qui permet de faire afficher une fenetre pour le moment. Comme nous ne pouvois pusher sur le serveur cette avant et apres midi à cause de l'installation d'un nouveau serveur a Repentigny, nous avons tout commit en même temps.

###`de 16h30 à 19h30`
Après les cours je suis rester jusqu'a 19h30 pour continuer ou jessy avait laisser. J'ai eu quelques problemes d'inclusions.
