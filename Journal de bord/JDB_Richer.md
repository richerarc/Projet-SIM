...
`De Mardi le 26 mai, à Lundi le 1 juin` GROS RUSH FINALE! J'ai beaucoup aidé Gab avec le canon à peinture et l'ajout d'objet dans les listes d'infoSalle, Xavier avec les serrures de portes, Dean avec son plafond tueur, Nathan avec les déplacement, et plusieurs autre... Aussi j'ai fini de spawner les objets dans les salles avec les items. j'ai aussi aider avec les puzzles, et j'ai fait tout les .txt des objets utile dans le jeu. Pour ce qui est de lundi, je vais préparer les build en release pour le présentation, ainsi que faire un cleanup finale pour le code. Nous allons aussi faire une préparation d'oral.  `Mar 6h00, Mer 6h00, Jeu 6h00, Ven 6h00, Sam 4h00, Dim 8h00, Lun 6h00`