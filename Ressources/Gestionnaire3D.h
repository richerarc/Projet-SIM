...
namespace gfx{
	...
	public:
		...
		void ajouterTexture(gfx::Texture* texture, Vecteur3d position, Vecteur3d normale){
			...
			gfx::Modele3D* plan = new gfx::Modele3D(gfx::GestionnaireRessources::obtInstance().obtModele("trouDeBalle.obj"), gfx::GestionnaireRessources::obtInstance().obtTexture("trouDeBalle.png"));
			plan->defPosition(position);
